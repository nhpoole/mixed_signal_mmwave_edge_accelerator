...
#draw_nguard [expr $nguard_lx] [expr $np_boundary_y + 0.2] [expr $nguard_ux] [expr $cell_uy]

# Draw guard ring for NFETs.
draw_pguard [expr $pguard_lx] [expr $cell_ly] [expr $pguard_ux] [expr $np_boundary_y - 10]
