...
N 200 -1070 200 -1060 { lab=#net5}
N 200 -1100 200 -1090 { lab=VSS}
N 200 -1070 270 -1070 { lab=#net5}
N 270 -1090 270 -1070 { lab=#net5}
...
N 450 -1180 500 -1180 { lab=VDD}
N 450 -1160 500 -1160 { lab=VSS}
N 440 -1000 490 -1000 { lab=VDD}
N 440 -980 490 -980 { lab=VSS}
N -1080 -930 -1060 -930 { lab=VDD}
N -1060 -980 -1060 -930 { lab=VDD}
N -1080 -910 -1060 -910 { lab=VSS}
N -1060 -910 -1060 -860 { lab=VSS}
N -1280 -1170 -1280 -1140 { lab=VDD}
N -1280 -980 -1280 -960 { lab=VSS}
N -1280 -890 -1280 -860 { lab=VSS}
N -1280 -700 -1280 -670 { lab=VDD}
N -910 -940 -910 -900 { lab=VDD}
N -850 -940 -850 -900 { lab=VSS}
C {devices/title.sym} 160 -30 0 0 {name=l1 author="Nikhil Poole"}
C {devices/code.sym} 440 -410 0 0 {name=STIMULI 
only_toplevel=true
place=end
value=".include low_freq_pll_commands.spice"}
C {devices/code.sym} 440 -560 0 0 {name=TT_MODELS
only_toplevel=true
...
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 580 -770 0 0 {name=l4 lab=GND}
...
C {/home/users/nhpoole/ee272b/ee272b_mixed_signal_mmwave_accelerator/designs/se_fold_casc_wide_swing_opamp.sym} 200 -800 3 1 {name=x2 Lbias='Lbias' Ibias='Ibias'}
C {devices/lab_wire.sym} 120 -1020 0 0 {name=l14 sig_type=std_logic lab=vtx}
C {devices/lab_wire.sym} 460 -1180 0 1 {name=l15 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 460 -1160 0 1 {name=l16 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 450 -980 0 1 {name=l17 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 450 -1000 0 1 {name=l18 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -380 -1140 0 1 {name=l8 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -390 -710 0 1 {name=l9 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -1060 -860 0 1 {name=l19 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -1060 -960 0 1 {name=l20 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -420 -870 0 1 {name=l7 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -420 -990 0 1 {name=l10 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -1280 -960 0 1 {name=l21 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -1390 -1100 0 1 {name=l22 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -1390 -740 0 1 {name=l23 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -1280 -1160 0 1 {name=l24 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -1280 -670 0 1 {name=l25 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -1280 -870 0 1 {name=l26 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -910 -920 0 0 {name=l27 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -850 -920 0 1 {name=l28 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 140 -1070 0 0 {name=l29 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 270 -1070 0 1 {name=l30 sig_type=std_logic lab=VDD}
