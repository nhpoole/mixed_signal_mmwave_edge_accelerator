...
N -350 -1140 -300 -1140 { lab=vcm}
N -460 -1360 -460 -1320 { lab=#net1}
N -250 -1360 -180 -1360 { lab=#net1}
N -180 -1360 -180 -1320 { lab=#net1}
N -320 -890 -320 -870 { lab=GND}
N -530 -870 -330 -870 { lab=GND}
N -330 -870 -260 -870 { lab=GND}
N -320 -920 -300 -920 { lab=GND}
N -300 -920 -300 -870 { lab=GND}
N -530 -1190 -530 -1170 { lab=vcmp_tail1}
N -530 -1190 -390 -1190 { lab=vcmp_tail1}
N -390 -1190 -390 -1170 { lab=vcmp_tail1}
N -460 -1260 -460 -1190 { lab=vcmp_tail1}
N -250 -1190 -250 -1170 { lab=vcmp_tail2}
N -250 -1190 -110 -1190 { lab=vcmp_tail2}
N -110 -1190 -110 -1170 { lab=vcmp_tail2}
N -180 -1260 -180 -1190 { lab=vcmp_tail2}
N 40 -280 60 -280 { lab=GND}
N 40 -280 40 -240 { lab=GND}
N -110 -320 -110 -310 { lab=#net2}
N -110 -320 -30 -320 { lab=#net2}
N -30 -340 -30 -320 { lab=#net2}
N -30 -320 60 -320 { lab=#net2}
N 60 -320 60 -310 { lab=#net2}
...
N -380 -980 -320 -980 { lab=vcmcp}
N -380 -980 -380 -920 { lab=vcmcp}
N -600 -1140 -570 -1140 { lab=vcm}
N -480 -1360 -480 -1290 { lab=#net1}
N -200 -1290 -180 -1290 { lab=#net1}
N -200 -1360 -200 -1290 { lab=#net1}
N -480 -1290 -460 -1290 { lab=#net1}
N -530 -1140 -390 -1140 { lab=VDD}
N -250 -1140 -110 -1140 { lab=VDD}
N -460 -1140 -460 -1100 { lab=VDD}
N -180 -1140 -180 -1100 { lab=VDD}
N -460 -1100 -460 -1090 { lab=VDD}
N -180 -1100 -180 -1090 { lab=VDD}
N -250 -870 -110 -870 { lab=GND}
N -260 -1360 -250 -1360 { lab=#net1}
N -300 -1140 -290 -1140 { lab=vcm}
N -260 -870 -250 -870 { lab=GND}
N -390 -1050 -250 -1050 { lab=vcmcp}
N -320 -1050 -320 -950 { lab=vcmcp}
N -70 -1140 -50 -1140 { lab=vcm}
N -460 -1090 -180 -1090 { lab=VDD}
N -250 -1110 -250 -1050 { lab=vcmcp}
N -390 -1110 -390 -1050 { lab=vcmcp}
...
N -180 -1360 20 -1360 { lab=#net1}
N 50 -1360 50 -1320 { lab=#net1}
N -140 -1290 10 -1290 { lab=vpbiascm}
N 20 -1360 50 -1360 { lab=#net1}
N 50 -1260 50 -1170 { lab=vpbiascm}
N -10 -1230 50 -1230 { lab=vpbiascm}
N -10 -1290 -10 -1230 { lab=vpbiascm}
N 50 -1110 50 -870 { lab=GND}
N -110 -870 50 -870 { lab=GND}
...
N -420 -1290 -390 -1290 { lab=vpbiascm}
N -390 -1340 -390 -1290 { lab=vpbiascm}
N -390 -1340 -10 -1340 { lab=vpbiascm}
N -10 -1340 -10 -1290 { lab=vpbiascm}
N 1360 -590 1360 -560 { lab=vcm}
N 50 -1290 70 -1290 { lab=#net1}
N 70 -1360 70 -1290 { lab=#net1}
N 50 -1360 70 -1360 { lab=#net1}
N -370 -280 -350 -280 { lab=GND}
N -370 -280 -370 -230 { lab=GND}
N -380 -920 -360 -920 { lab=vcmcp}
...
N 320 -470 360 -470 { lab=vcm}
N 860 -470 900 -470 { lab=vom}
N -530 -890 -530 -870 { lab=GND}
N -530 -920 -510 -920 { lab=GND}
N -510 -920 -510 -870 { lab=GND}
N -590 -980 -530 -980 { lab=#net3}
N -590 -980 -590 -920 { lab=#net3}
N -590 -920 -570 -920 { lab=#net3}
N -530 -1110 -530 -950 { lab=#net3}
N -110 -890 -110 -870 { lab=GND}
N -130 -920 -110 -920 { lab=GND}
N -130 -920 -130 -870 { lab=GND}
N -110 -980 -50 -980 { lab=#net4}
N -50 -980 -50 -920 { lab=#net4}
N -70 -920 -50 -920 { lab=#net4}
N -110 -1110 -110 -950 { lab=#net4}
...
only_toplevel=true
place=end
value=".include diff_fold_casc_opamp_commands.spice"}
...
descr="gm="}
C {devices/vsource.sym} 1270 -530 0 0 {name=V1 value='vincm+vsig/2' only_toplevel=true}
...
C {devices/vsource.sym} 1180 -530 0 0 {name=V4 value='vincm-vsig/2' only_toplevel=true}
...
C {devices/lab_wire.sym} -300 -1140 0 0 {name=l19 sig_type=std_logic lab=vcm}
C {devices/gnd.sym} -240 -870 0 0 {name=l20 lab=GND}
C {sky130_fd_pr/pfet_01v8.sym} -370 -1140 0 1 {name=M5
L=0.8
W='Wp_cm'
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -270 -1140 0 0 {name=M7
L=0.8
W='Wp_cm'
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -550 -1140 0 0 {name=M8
L=0.8
W='Wp_cm'
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -90 -1140 0 1 {name=M9
L=0.8
W='Wp_cm'
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -440 -1290 0 1 {name=M10
L=0.8
W='Wp*0.5'
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -160 -1290 0 1 {name=M11
L=0.8
W='Wp*0.5'
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} -340 -920 0 0 {name=M12
L=1.2
W=0.7
nf=1 
mult=2
...
C {devices/vdd.sym} -320 -1090 0 0 {name=l21 lab=VDD}
...
C {devices/isource.sym} 50 -1140 0 0 {name=I1 value='Itail'}
C {sky130_fd_pr/pfet_01v8.sym} 30 -1290 0 0 {name=M15
L=0.8
W='Wp*0.5'
nf=1
mult=1
...
C {devices/lab_wire.sym} -420 -1190 0 0 {name=l12 sig_type=std_logic lab=vcmp_tail1}
C {devices/lab_wire.sym} -140 -1190 0 0 {name=l17 sig_type=std_logic lab=vcmp_tail2}
C {devices/lab_wire.sym} -450 -550 0 0 {name=l18 sig_type=std_logic lab=vpbias}
C {devices/lab_wire.sym} 50 -1190 0 0 {name=l22 sig_type=std_logic lab=vpbiascm}
C {devices/lab_wire.sym} -200 -280 0 0 {name=l23 sig_type=std_logic lab=vnbias}
C {devices/lab_wire.sym} -580 -1140 0 0 {name=l24 sig_type=std_logic lab=vcm}
C {devices/lab_wire.sym} -50 -1140 0 0 {name=l25 sig_type=std_logic lab=vcm}
C {devices/lab_wire.sym} -320 -1010 0 0 {name=l26 sig_type=std_logic lab=vcmcp}
...
C {sky130_fd_pr/nfet_01v8.sym} -550 -920 0 0 {name=M27
L=1.2
W=0.7
nf=1 
mult=2
...
C {sky130_fd_pr/nfet_01v8.sym} -90 -920 0 1 {name=M28
L=1.2
W=0.7
nf=1 
mult=2
