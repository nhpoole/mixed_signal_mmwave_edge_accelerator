////////////////////////////////////////////////////////////////////////////////
//
// Filename: 	cordic_rect_to_polar.h
// {{{
...
//
// }}}
#ifndef	CORDIC_RECT_TO_POLAR_H
#define	CORDIC_RECT_TO_POLAR_H
...
const double	QUANTIZATION_VARIANCE = 0.1963924997170268; // (Units^2)
const double	PHASE_VARIANCE_RAD = 0.0000000286645747; // (Radians^2)
const double	GAIN = 0.8233801270156462;
const bool	HAS_RESET = true;
const bool	HAS_AUX   = true;
#define	HAS_RESET_WIRE
#define	HAS_AUX_WIRES
#endif	// CORDIC_RECT_TO_POLAR_H
